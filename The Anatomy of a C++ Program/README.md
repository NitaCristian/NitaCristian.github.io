...
In this lesson, you learn ■The parts of a C++ program ■How the parts work together ■What a function is and what it does ■Basic input and output operations
...
The execution of a C++ program always starts in the function main(). It is a standardized convention that function main() is declared with an int preceding it.
