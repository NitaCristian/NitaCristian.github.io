...
In this lesson, you find out ■How to declare and define variables and constants ■How to assign values to variables and manipulate those values ■How to write the value of a variable to the screen ■How to use keywords auto and constexpr
