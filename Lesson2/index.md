...
#include \<filename> tells the  preprocessor to take the contents of the file (iostream, for example) and include them at the line where the directive is made.
