...
In this lesson, you learn ■What arrays are and how to declare and use them ■What strings are and how to use character arrays to make them ■A brief introduction to std::string
